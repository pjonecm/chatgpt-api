...
> When this skill and the code disagree, trust the code (`CLAUDE.md` §0).
...
- `CLAUDE.md` §8 (roles/auth), §11 (DB), §16 (security constraints), §17 (Windows caveat)
...
12. Update only the required documentation (per `CLAUDE.md` §15).
...
Based on `CLAUDE.md` §14. Run the matching subset for the change type:
...
platform/test mismatch (`CLAUDE.md` §17), **not a code defect**. Do not relax
